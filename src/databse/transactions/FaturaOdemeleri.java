...
public class FaturaOdemeleri extends DbConnection implements IBilgiContoller {

    private String faturaIsmi = null;
    private double faturaTutari = 0;

    /*
    Fauturaların ödendiğini kontrol etmek ve Database de güncellemek için
    UPDATE komutu ile SQL sorgusu yazdım.
     */
    ...
    /*
    Fatura tutarı 0 ise ve bakiyeden fazla ise false döndürüyorum.
    */
    @Override
    ...
    /*
    Mevcut bakiyeden fatura tutarını çıkartmak, Hesap ekranında güncel bakiyeyi göstermek için ve
    Database de güncellemek için yazdığım SQL komutu.
    */
    ...
    /* 
    Fatura ödendikten sonra sıfırlamak için.
    */
